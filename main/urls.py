...
from . import views
from main.views import show_main, create_survival_entry, edit_survival_entry, delete_survival_entry, add_survival_entry_ajax, create_survival_flutter 
...
urlpatterns = [
    ...
    path('create-survival-flutter', create_survival_flutter, name='create_survival_flutter'),
